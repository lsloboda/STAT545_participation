...
```{r}
a > 0 && a < 5 #not vectorized, useful for if statements
...
```{r}
names(course) <- c("subject", "code", "section") #c function is for constructing vectors
course
#names(course)
```
...
```{r}
my_list[2]
my_list[[2]] #don't give me the first entry in the list, give me the contents of the first entry
```
...
```{r}
my_list["year"]
my_list[["year"]] #similarly, it returns the contents
my_list$year #more commonly used
```
