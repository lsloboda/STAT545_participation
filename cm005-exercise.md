...
#difference: notebook doesn't re-run R code from top to bottom
...
#CTRL + ALT + I to make a new code chunk
...
## # ... with 1,694 more rows
```
#to learn more about select, type ??select into the console
...
#CTRL + SHIFT + M to pipe; by default, the output becomes the first argument of the next function
...
#filter function must use a logical argument
#can use ! as 'not' (inverse statement)
