...
gvsl + geom_smooth(method='lm') + geom_point(alpha=0.2)
```
...
gapminder %>%
  ...
  geom_bar()
  #geom_col can specify the height  manually
```
...
yvsl + geom_smooth(method='lm', aes(color=continent), se=FALSE)
...
ggplot(gapminder, aes(year, lifeExp)) +
  geom_smooth(method='lm', aes(color=continent), se=FALSE) +
